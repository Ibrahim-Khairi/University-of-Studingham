    ...
    const fetchPlatformStatus = async () => {
      try {
        ...
        const res = await axios.get(
          "http://localhost:5000/api/admin/platform-status",
          {
            headers: {
              Authorization: `Bearer ${token}`,
            },
              ...
              <div className="bg-[#4C86A8] p-6 rounded-3xl mt-5">
                {loading || adminLoading ? (
                  ...
                  <>
                    ...
                    <p className="text-white text-[18px] font-medium">
                      {adminProfile.firstName} {adminProfile.middleName}{" "}
                    ...
                    <p className="text-white text-[18px] font-medium">
                      Last Action:{" "}
                      {latestAction?.description || "No actions yet"}
                    </p>
                  </>
                )}
              </div>
                ...
                <div className="space-y-1">
                  {loadingActivity ? (
                    ...
                    activities.map((activity) => (
                      ...
                      >
                        <img
                          src="/Images/Icons/recentUpdatesPointer.svg"
                          alt="Pointer"
                        />
                        <p className="text-[16px] font-medium">
                        ...
                        <img
                          src="/Images/Icons/Ellipse%2049.svg"
                          alt="Ellipse"
                        />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 gap-4">
                ...
                >
                  ...
                  >
                    ...
                    />
                    <path
                      d="M21 19H50.5556C54.5371 19 56.5258 19 57.7629 20.2306C59 21.4612 59 23.4394 59 27.4V40C59 43.9606 59 45.9388 57.7629 47.1694C56.5258 48.4 54.5371 48.4 50.5556 48.4H35.7778M37.8889 28.45H50.5556M21 50.5V42.1C21 40.1197 21 39.1306 21.6186 38.5153C22.2371 37.9 23.2314 37.9 25.2222 37.9H29.4444M21 50.5H29.4444M21 50.5V61M29.4444 37.9V50.5M29.4444 37.9H42.1111M29.4444 50.5V61"
                      stroke="#13B7B3"
                      strokeWidth="4"
                      strokeLinecap="round"
                    ...
                    >
                      ...
                      <div>
                        <p className="text-[26px] font-bold text-black">
                          {registration.meta?.name || "Unknown User"}
                        </p>
                        <p className="text-sm text-gray-500 font-bold">
                          {registration.meta?.role || "Unknown Role"},{" "}
                          {registration.meta?.courseCode
