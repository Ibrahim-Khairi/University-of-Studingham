    ...
    return (
        <BrowserRouter>
            ...
            <Routes>
                ...
                <Route path="/student/moodle" element={<AuthGate allowedRoles={["student"]}><Moodle /></AuthGate>} />
                <Route path="/student/timetable" element={<AuthGate allowedRoles={["student"]}><Timetable /></AuthGate>} />
                <Route path="/student/finance-tracker" element={<AuthGate allowedRoles={["student"]}><Financetracker /></AuthGate>} />
                <Route path="/student/library-portal" element={<AuthGate allowedRoles={["student"]}><LibraryPortal /></AuthGate>} />
                <Route path="/student/library-collection" element={<AuthGate allowedRoles={["student"]}><Librarycollection /></AuthGate>} />
                <Route path="/student/book-detail/:id" element={<AuthGate allowedRoles={["student"]}><Bookdetail /></AuthGate>} />
