      ...
      <div className="relative z-10 px-6 py-10 max-w-5xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="text-white">
            ...
            <div className="flex items-center gap-4 bg-white rounded-md p-4 text-black">
              ...
              <div>
                <p className="text-xs text-gray-600">
                  Upload square image (under 300KB)
                </p>
          ...
          <div className="flex justify-center mt-10">
            <button
              type="submit"
              className="px-16 py-3 rounded-full bg-green-600 hover:bg-green-700 text-white font-black uppercase tracking-widest text-xs transition duration-300 shadow-xl active:scale-95"
            >
              Register Now
            </button>
          </div>
