    ...
    <div>
      <div className="bg-[#72333B]">
        <div className="flex justify-between text-white py-6 items-center container">
          <div>
            <Link className="text-[28px] font-[Dela Gothic One] ">
              Studingham Library
            </Link>
          </div>
          <div className="flex gap-6">
            <Link className="text-[22px]">Collection</Link>
            <Link className="text-[22px]">Personal History</Link>{" "}
            <Link className="text-[22px]">Mentorship</Link>
          </div>
          <div></div>
        </div>
      </div>
